...
// Both or one of selector and customAttribute must be defined.
    ...
    .run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', '$mdDialog', '$q', '$timeout', '$interval', '$rootScope', function (taRegisterTool, $window, taTranslations, taSelection, $mdDialog, $q, $timeout, $interval, $rootScope) {
        taRegisterTool("html", {
