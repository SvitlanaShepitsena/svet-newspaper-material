...
angular.module('lumx.dropdown', [])
    ...
    .controller('LxDropdownController', ['$scope', '$timeout', '$window', 'LxDropdownService', function ($scope, $timeout, $window, LxDropdownService) {
        ...
        function setDropdownMenuCss() {
            ...
            if (origin.y + dropdownMenuHeight >= $window.innerHeight && origin.y - dropdownMenuHeight > 0) { // To top
            ...
            else if (origin.y + dropdownMenuHeight < $window.innerHeight) { // To bottom
            ...
            $scope.$watch('data.selected', function (newValue) {
                ...
                convertValue(data,
                    ...
                    function (newConvertedValue) {
                        ...
                        if ($scope.change) {
                            $scope.change({
                                newValue: angular.copy(newConvertedValue),
                                oldValue: angular.copy($scope.ngModel.$modelValue)
                            });
                        }
...
angular.module("lumx.dropdown").run(['$templateCache', function (a) {
    a.put('dropdown.html', '<div class="dropdown" ng-transclude="parent"></div>\n' +
    '');
...
angular.module("lumx.file-input").run(['$templateCache', function (a) {
    a.put('file-input.html', '<div class="input-file">\n' +
...
angular.module("lumx.text-field").run(['$templateCache', function (a) {
    a.put('text-field.html', '<div class="text-field text-field--{{ theme }}-theme"\n' +
...
angular.module("lumx.search-filter").run(['$templateCache', function (a) {
    a.put('search-filter.html', '<div class="search-filter search-filter--{{ theme }}-theme"\n' +
...
angular.module("lumx.select").run(['$templateCache', function (a) {
    a.put('select.html', '<div class="lx-select"\n' +
...
angular.module("lumx.tabs").run(['$templateCache', function (a) {
    a.put('tabs.html', '<div class="tabs tabs--theme-{{ linksTc }} tabs--layout-{{ layout }}"\n' +
...
angular.module("lumx.date-picker").run(['$templateCache', function (a) {
    a.put('date-picker.html', '<div class="lx-date" ng-class="{ \'lx-date--fixed-label\': fixedLabel(),\n' +
...
angular.module("lumx.progress").run(['$templateCache', function (a) {
    a.put('progress.html', '<div class="progress-circular-container" ng-if="type === \'circular\'">\n' +
