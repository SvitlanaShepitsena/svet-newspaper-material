...
angular.module("mwl.calendar").run(["$templateCache", function ($templateCache) {
    ...
    $templateCache.put("templates/year.html", "<div class=\"cal-year-box\"><div ng-repeat=\"year in view track by $index\"><div class=\"row cal-before-eventlist\"><div class=\"span3 col-md-3 col-xs-6 cal-cell\" ng-repeat=\"month in year track by $index\" ng-click=\"monthClicked($parent.$index, $index)\" ng-class=\"{pointer: month.events.length > 0, \'cal-day-today\': month.isToday}\"><span class=\"pull-right\" data-cal-date ng-click=\"drillDown(month.monthIndex)\">{{ month.label }}</span>" +
        "" +
        ...
        " <div class=\"cal-day-tick \" ng-show=\"!month.isOpened && month.events.length>0\"><i class=\"glyphicon glyphicon-chevron-down\"></i> <i class=\"fa fa-chevron-up\"></i></div>"
        +
