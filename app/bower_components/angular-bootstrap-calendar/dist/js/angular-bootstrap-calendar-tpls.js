...
(function (window, angular) {
    ...
    angular.module('mwl.calendar').run([
        ...
        function ($templateCache) {
            ...
            $templateCache.put('src/templates/calendarSlideBox.html', '<div class="cal-slide-box" collapse="vm.shouldCollapse" mwl-collapse-fallback="vm.shouldCollapse">\n    <div class="cal-slide-content cal-event-list">\n        <ul class="unstyled list-unstyled">\n            <li ng-repeat="event in events track by $index">\n                <a href="javascript:;" class="event-item" ng-click="onEventClick({calendarEvent: event})">\n\n                    <span class="label label-default tc-grey-600 bgc-red-50 mr" style="display: inline-block"\n                          ng-if="event.type===\'connection\'"> \n                    <i class="mdi mdi-briefcase-check" style="font-size: 14px"\n                       ng-show=\'event.type==="connection"\'></i>\n                        Svet Connection Event\n                    </span>\n                    \n                    <span class="label label-default tc-grey-600 bgc-teal-50 mr" style="display: inline-block"\n                          ng-if="event.type===\'public\'">    \n                    <i class="fa fa-users" style="font-size: 11px" ng-show=\'event.type==="public"\'></i>\n                        Svet Public Event \n                    </span>\n\n                    <span class="label label-default tc-grey-600 bgc-grey-200 mr" style="display: inline-block"\n                          ng-if="event.type===\'community\'"> \n                    <i class="mdi mdi-city" style="font-size: 14px" ng-show=\'event.type==="community"\'></i>\n                        Chicago Community Event\n                    </span>\n\n                    <span ng-bind="event.title" class="tc-grey-700"> </span> \n                    <span ng-show="isMonthView">(<span\n                            ng-bind="event.startsAt | date:\'shortTime\'"></span>)</span> \n                    <span ng-show="isYearView">\n                        <span class="fs-caption tc-grey-600"\n                            ng-bind="event.startsAt | date:\'MMM d, h:mm a\'">\n                    </span>\n                    </span>\n                </a>\n                <a href="javascript:;"\n                   class="event-item-edit"\n                   ng-if="editEventHtml && event.editable !== false"\n                   ng-bind-html="vm.$sce.trustAsHtml(editEventHtml)"\n                   ng-click="onEditEventClick({calendarEvent: event})">\n                </a>\n                <a href="javascript:;" class="event-item-delete" ng-if="deleteEventHtml && event.deletable !== false"\n                   ng-bind-html="vm.$sce.trustAsHtml(deleteEventHtml)"\n                   ng-click="onDeleteEventClick({calendarEvent: event})"></a></li>\n        </ul>\n    </div>\n</div>');
