        ...
        angular.module("material.core").factory("$mdUtil", ["$cacheFactory", "$document", "$timeout", "$q", "$window", "$mdConstant", function (t, n, r, o, a, i) {
            ...
            return d = {
                ...
                transitionEndPromise: function (e, t) {
                    function n(t) {
                        t && t.target !== e[0] || (e.off(i.CSS.TRANSITIONEND, n), a.resolve())
                    }

                    t = t || {};
                    var a = o.defer();
                    return e.on(i.CSS.TRANSITIONEND, n), t.timeout && r(n, t.timeout), a.promise
                },
 ...
 */
    function () {
        ...
        function t(e, t) {
            ...
            function o(e, t, n) {
                return a(e, t, angular.extend({center: !1, dimBackground: !0, outline: !1, rippleSize: "full"}, n))
            }
            ...
            function a(n, r, o) {
                ...
                function l(n, c) {
                    ...
                    function s(e, t) {
                        ...
                        return o.isMenuItem ? r = Math.sqrt(Math.pow(i, 2) + Math.pow(c, 2)) : o.outline ? (a = M.getBoundingClientRect(), e -= a.left, t -= a.top, i = Math.max(e, i - e), c = Math.max(t, c - t), r = 2 * Math.sqrt(Math.pow(i, 2) + Math.pow(c, 2))) : (n = o.fullRipple ? 1.1 : .8, r = Math.sqrt(Math.pow(i, 2) + Math.pow(c, 2)) * n, o.fitRipple && (r = Math.min(c, i, r))), r
                    }
        ...
        function e(e, n, r, o) {
            function a(t, a, i, c) {
                ...
                function u(e, t, n, r, o, a, i) {
                    ...
                    switch (a) {
                        case"fixed":
                            s.top = w({unit: i, offset: e.row, gutter: o}), s.height = k({
                                unit: i,
                                span: t.row,
                                gutter: o
                            });
                        ...
                        case"ratio":
                            ...
                            break;
                        case"fit":
                            var f = 1 === r ? 0 : (r - 1) / r, m = 1 / r * 100, u = T({
                                share: m,
                                gutterShare: f,
                                gutter: o
                            });
                            s.top = w({unit: u, offset: e.row, gutter: o}), s.height = k({
                                unit: u,
                                span: t.row,
                                gutter: o
                            })
    ...
    function () {
        ...
        function e(e, t, n, r, o) {
            function a(r, a) {
                ...
                var c = '<div class="md-select-menu-container"><md-select-menu ' + (angular.isDefined(a.multiple) ? "multiple" : "") + ">" + r.html() + "</md-select-menu></div>";
                return r.empty().append(i), n(r), function (n, r, a, i) {
                    function d() {
                        if (f) {
                            var e = f.find("md-select-menu").controller("mdSelectMenu");
                    ...
                    function l() {
                        ...
                        e.data("$ngModelController", g), e.data("$mdSelectController", h), p = n.$new(), f = o(f)(p)
                    }

                    function s(e) {
                        var t = [32, 13, 38, 40];
                        -1 != t.indexOf(e.keyCode) && (e.preventDefault(), m(e))
                    }
                    ...
                    var u, f, p, h = i[0], g = i[1], b = r.find("md-select-label"), v = 0 !== b.text().length;
                    l();
                    var E = g.$render;
                    g.$render = function () {
                        E(), d()
                        ...
                        if (!v) {
                            ...
                            var t = e || a.placeholder || "", n = v ? b : b.children().eq(0);
                            n.text(t)
                        }
                    }, h.setIsPlaceholder = function (e) {
                        e ? b.addClass("md-placeholder") : b.removeClass("md-placeholder")
                    }, n.$$postDigest(d), a.$observe("disabled", function (e) {
                        "string" == typeof e && (e = !0), e ? (r.attr("tabindex", -1), r.off("click", m), r.off("keydown", s)) : (r.attr("tabindex", 0), r.on("click", m), r.on("keydown", s))
                    }), a.disabled || a.ngDisabled || (r.attr("tabindex", 0), r.on("click", m), r.on("keydown", s)), r.attr({
                        role: "combobox",
        ...
        function n(e, t) {
            ...
            function r(n, r, o, a) {
                ...
                o.$observe("selected", function (e) {
                    angular.isDefined(e) && (e ? (l.isMultiple || l.deselect(Object.keys(l.selected)[0]), l.select(d.hashKey, d.value)) : l.deselect(d.hashKey), l.refreshViewValue(), l.ngModel.$render())
            ...
            function t(e, t, o, c, d, l) {
                ...
                function u(e, a, d) {
                    ...
                    if (l) {
                        ...
                        y.paddingLeft = parseInt(x.paddingLeft, 10) || 0, y.paddingRight = parseInt(x.paddingRight, 10) || 0
                    }
                    var C = l;
                    ...
                    var _, S, H;
                    b ? (_ = g.left, S = g.top + g.height, H = "50% 0", S + k.height > v.bottom && (S = g.top - k.height, H = "50% 100%")) : (_ = g.left + y.left - y.paddingLeft, S = g.top + g.height / 2 - y.height / 2 - y.top + p.scrollTop, H = y.left + g.width / 2 + "px " + (y.top + y.height / 2 - p.scrollTop) + "px 0px", s.style.minWidth = g.width + y.paddingLeft + y.paddingRight + "px");
                    var D = s.getBoundingClientRect();
                    s.style.left = n(v.left, _, v.right - D.width) + "px", s.style.top = n(v.top, S, v.bottom - D.height) + "px", f.style[t.CSS.TRANSFORM_ORIGIN] = H, f.style[t.CSS.TRANSFORM] = "scale(" + Math.min(g.width / k.width, 1) + "," + Math.min(g.height / k.height, 1) + ")", o(function () {
 ...
 */
    function () {
        ...
        function t(e, t, n, r, o, a, i, c, d, l) {
            function s(s, m, u, f) {
                function p(e, n) {
                    s.isLockedOpen = e, e === n ? m.toggleClass("md-locked-open", !!e) : t[e ? "addClass" : "removeClass"](m, "md-locked-open"), T.toggleClass("md-locked-open", !!e)
                }

                function h(e) {
                    var n = m.parent();
                    return n[e ? "on" : "off"]("keydown", b), T[e ? "on" : "off"]("click", v), e && (E = l[0].activeElement), $ = d.all([t[e ? "enter" : "leave"](T, n), t[e ? "removeClass" : "addClass"](m, "md-closed").then(function () {
                        s.isOpen && m.focus()
                    })])
                }

                function g(t) {
                    if (s.isOpen == t)return d.when(!0);
                    var n = d.defer();
                    return s.isOpen = t, e(function () {
                        $.then(function (e) {
                            s.isOpen || (E && E.focus(), E = null), n.resolve(e)
                        })
                    }, 0, !1), n.promise
                }
                ...
                function b(e) {
                    ...
                    return t ? v(e) : d.when(!0)
                }

                function v(e) {
                    return e.preventDefault(), e.stopPropagation(), f.close()
                }

                var E = null, $ = d.when(!0), M = n(u.mdIsLockedOpen), A = function () {
                    return M(s.$parent, {
                        $media: function (e) {
                            return r.warn("$media is deprecated for is-locked-open. Use $mdMedia instead."), o(e)
                        }, $mdMedia: o
                    })
                }, T = i('<md-backdrop class="md-sidenav-backdrop md-opaque ng-enter">')(s);
                m.on("$destroy", f.destroy), c.inherit(T, m), s.$watch(A, p), s.$watch("isOpen", h), f.$toggleOpen = g
            }
    ...
    function () {
        ...
        function e(e, t, n, r, o, a, i, c) {
            ...
            function l(n, d, l, s) {
                ...
                function x(e) {
                    j() || (J = !0, e.stopPropagation(), d.addClass("dragging"), _(e))
                }
                ...
                var I = l.ngDisabled && c(l.ngDisabled), j = I ? function () {
                    return I(n.$parent)
                } : angular.noop, P = angular.element(d[0].querySelector(".md-thumb")), L = angular.element(d[0].querySelector(".md-thumb-text")), F = P.parent(), B = angular.element(d[0].querySelector(".md-track-container")), q = angular.element(d[0].querySelector(".md-track-fill")), V = angular.element(d[0].querySelector(".md-track-ticks")), U = r.throttle(b, 5e3);
                ...
                function b() {
                    function e() {
                        var e = "left" === M || "right" === M ? 2 * Math.sqrt(Math.pow(r.width, 2) + Math.pow(r.height / 2, 2)) : 2 * Math.sqrt(Math.pow(r.width / 2, 2) + Math.pow(r.height, 2)), t = "left" === M ? {
                            left: 100,
                            top: 50
                        } : "right" === M ? {left: 0, top: 50} : "top" === M ? {left: 50, top: 100} : {
                            left: 50,
                            top: 0
                        };
 ...
 */
    function () {
        ...
        function e(e, t, n, r, o) {
            ...
            return M.scope = e, M.parent = e.$parent, M.itemName = A[0], M.matches = [], M.loading = !1, M.hidden = !0, M.index = 0, M.keydown = p, M.blur = f, M.clear = h, M.select = E, M.getCurrentDisplayValue = b, M.fetch = r.debounce(s), M.messages = [], M.listEnter = function () {
                x = !0
            }, M.listLeave = function () {
                x = !1
            }, M.mouseUp = function () {
                w.input.focus()
            }, a()
