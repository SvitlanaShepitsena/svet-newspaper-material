(function () {
    ...
    angular.module('article')
        .directive('svNewArticleForm', function (SectionsServ, NewsGeneratorServ, CurrentUserServ, FormattedDateServ, TagsServ) {
            return {
                replace: true,
                ...
                link: function ($scope, el, attrs) {
                    ...
                    $scope.dateMod = '';
                    NewsGeneratorServ.getPoliticalNews(20, true).then(function (realNews) { $scope.article = {
                            isDraft: true,
                            img: realNews.img,
                            isTopNews: false,
